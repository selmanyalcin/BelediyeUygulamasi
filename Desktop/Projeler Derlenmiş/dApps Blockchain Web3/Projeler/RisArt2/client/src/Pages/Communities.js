  ...
  useEffect(() => {
    get(child(dbref, "Community/")).then((snapshot) => {
      ...
      for (let id in communities) {
        communityList.push(communities[id].name);
      ...
      <div className="BottomMain">
        ...
        <div className="ContentArea">
          ...
          <div className="CommunityDiv">
            <Link className="CommunityLink" to="/Marvel">
              <div
                style={{
                  display: "flex",
                  flexDirection: "row",
          ...
          <div className="CommunityDiv">
            <Link className="CommunityLink" to="/MorganFreeman">
              <div
                style={{
                  display: "flex",
                  flexDirection: "row",
          ...
          <div className="CommunityDiv">
            <Link className="CommunityLink" to="/Fenerbahce">
              <div
                style={{
                  display: "flex",
                  flexDirection: "row",
          ...
          <div className="CommunityDiv">
            <Link className="CommunityLink" to="/Orkun">
              <div
                style={{
                  display: "flex",
                  flexDirection: "row",
