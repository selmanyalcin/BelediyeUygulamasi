...
export default function Profile() {
  ...
  useEffect(() => {
    ...
    get(child(dbref, "Users/" + state.profileName)).then((snapshot) => {
      if (snapshot.exists()) {
    ...
    get(
      child(dbref, "Users/" + state.profileName + "/Subscribers/" + UserMail)
    ).then((snapshot) => {
      if (snapshot.exists()) {
        get(child(dbref, "Users/" + state.profileName + "/PremiumWorks")).then(
          (snapshot) => {
