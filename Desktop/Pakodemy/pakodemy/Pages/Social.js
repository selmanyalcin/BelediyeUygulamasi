      ...
      <View style={styles.Social}>
        ...
        <View style={styles.Friends}>
          ...
          >
            ...
            <Text style={styles.Text2}>1989 Puan</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => navigation.navigate("Arkadaşım")}
            style={styles.Friend}
          >
            ...
            <Text style={styles.Text2}>1866 Puan</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => navigation.navigate("Arkadaşım")}
            style={styles.Friend}
          >
            ...
            <Text style={styles.Text2}>1798 Puan</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => navigation.navigate("Arkadaşım")}
            style={styles.Friend}
          >
            ...
            <Text style={[styles.Text2, { marginLeft: "38%" }]}>1654 Puan</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => navigation.navigate("Arkadaşım")}
            style={styles.Friend}
          >
            ...
            <Text style={styles.Text2}>1489 Puan</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => navigation.navigate("Arkadaşım")}
            style={styles.Friend}
          >
            ...
            <Text style={styles.Text2}>1300 Puan</Text>
          </TouchableOpacity>
        </View>
      </View>
