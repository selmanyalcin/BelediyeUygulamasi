      ...
      <View style={styles.Social}>
        ...
        <View style={styles.Friends}>
          ...
          >
            ...
            <Text style={styles.Text2}>2. Sıra</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => navigation.navigate("Arkadaşım")}
            style={styles.Friend}
          >
            ...
            <Text style={styles.Text2}>7.Sıra</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => navigation.navigate("Arkadaşım")}
            style={styles.Friend}
          >
            ...
            <Text style={styles.Text2}>12.Sıra</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => navigation.navigate("Arkadaşım")}
            style={styles.Friend}
          >
            ...
            <Text style={[styles.Text2, { marginLeft: "38%" }]}>17.Sıra</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => navigation.navigate("Arkadaşım")}
            style={styles.Friend}
          >
            ...
            <Text style={styles.Text2}>26.Sıra</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => navigation.navigate("Arkadaşım")}
            style={styles.Friend}
          >
            ...
            <Text style={styles.Text2}>32.Sıra</Text>
          </TouchableOpacity>
        </View>
      </View>
